...
export default function StripeButtonMonthlyFifty() {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      buyButton.setAttribute('buy-button-id', 'buy_btn_1Qq6a7078p2tLrNyXApceECX');
      ...
      const container = document.getElementById('stripe-buy-button-container-m50');
      if (container) {
  ...
  return <div id="stripe-buy-button-container-m50"></div>;
}