...
export default function Home() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-6">
      ...
      <h1 className="text-2xl text-center text-red-500 font-semibold"> 12 ĐẶC ĐIỂM CỦA THÁNH GIUSE MÀ <br/>MỖI NGƯỜI CHA NÊN NOI GƯƠNG </h1>
      </div>
